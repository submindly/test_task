...
class OrgSearch(unittest.TestCase):
    ...
    def test_search_in_ya(self):
        ...
        time.sleep(1)
        #assert driver.find_element_by_xpath("//a[ancestor::ul/@class='serp-list serp-list_left_yes']") == 'https://tensor.ru'
        self.assertEquals('https://tensor.ru', driver.find_element_by_xpath("//a[ancestor::ul/@class='serp-list serp-list_left_yes']"))
